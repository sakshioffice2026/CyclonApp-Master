...
wrapper supplies the deliberate sheet coordinates used for the final drawing.
"""
...
# Third-angle principal-view arrangement: top above front, right side to right.
_C = (95.0, 140.0)
_T = (95.0, 258.0)
_S = (220.0, 140.0)
_DETAILS = {
...
def compose_engineering_sheet(*, view_paths, section_paths, output_path, dims, revision_id):
    ...
    # layout, move the labels into the intentional annotation bands so they do
    # not collide with the detail geometry or the title block.
